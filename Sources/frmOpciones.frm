...
Begin VB.Form frmOpciones 
   ...
   Begin ClientGSZAO.uAOCheckbox ChkMusica 
      Height          =   225
      Left            =   435
      TabIndex        =   11
      Top             =   990
   ...
   Begin MSComctlLib.Slider Slider1 
      ...
      TickStyle       =   3
   End
   Begin ClientGSZAO.uAOButton cAceptar 
      Height          =   375
      Left            =   1440
      TabIndex        =   4
      Top             =   6555
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cTutorial 
      Height          =   375
      Left            =   2520
      TabIndex        =   5
      Top             =   6120
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cCambiarContrasena 
      Height          =   375
      Left            =   2520
      TabIndex        =   6
      Top             =   5640
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cMensajesPersonalizados 
      Height          =   375
      Left            =   2520
      TabIndex        =   7
      Top             =   5160
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cConfigurarTeclas 
      Height          =   375
      Left            =   360
      TabIndex        =   8
      Top             =   5160
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cVerMapa 
      Height          =   375
      Left            =   360
      TabIndex        =   9
      Top             =   5640
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cSoporte 
      Height          =   375
      Left            =   360
      TabIndex        =   10
      Top             =   6120
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOCheckbox ChkSonidos 
      Height          =   225
      Left            =   435
      TabIndex        =   12
      Top             =   1260
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkEfectosSonidos 
      Height          =   225
      Left            =   435
      TabIndex        =   13
      Top             =   1545
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkClanConsola 
      Height          =   225
      Left            =   435
      TabIndex        =   14
      Top             =   2430
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkClanPantalla 
      Height          =   225
      Left            =   1950
      TabIndex        =   15
      Top             =   2430
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkClanMostrarNoticias 
      Height          =   225
      Left            =   435
      TabIndex        =   16
      Top             =   3315
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkActivarFragshooter 
      Height          =   225
      Left            =   435
      TabIndex        =   17
      Top             =   4110
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkFragAlMorir 
      Height          =   225
      Left            =   435
      TabIndex        =   18
      Top             =   4740
   ...
   End
   Begin ClientGSZAO.uAOCheckbox ChkFragRequiereNivel 
      Height          =   225
      Left            =   435
      TabIndex        =   19
      Top             =   4425
...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(pathGUI & "frmOpciones.jpg")
