...
Begin VB.Form frmComerciarUsu 
   ...
   Begin ClientGSZAO.uAOButton cCancelar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cConfirmar 
      Height          =   495
      Left            =   7560
      TabIndex        =   10
      Top             =   4080
   ...
   Begin ClientGSZAO.uAOButton cAceptar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cRechazar 
      Height          =   495
      Left            =   8280
      TabIndex        =   12
      Top             =   8160
   ...
   Begin ClientGSZAO.uAOButton cAgregar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cQuitar 
      Height          =   375
      Left            =   4500
      TabIndex        =   15
      Top             =   2640
...
'**********************************
    ...
    Me.Picture = LoadPicture(pathGUI & "frmComerciarUsu.jpg")
