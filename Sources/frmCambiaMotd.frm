...
Begin VB.Form frmCambiaMotd 
   ...
   Begin VB.TextBox txtMotd 
      ...
      Width           =   4290
   End
   Begin ClientGSZAO.uAOButton cAzul 
      Height          =   375
      Left            =   480
      TabIndex        =   1
      Top             =   3240
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cRojo 
      Height          =   375
      Left            =   1560
      TabIndex        =   2
      Top             =   3240
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cBlanco 
      Height          =   375
      Left            =   2640
      TabIndex        =   3
      Top             =   3240
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cGris 
      Height          =   375
      Left            =   3600
      TabIndex        =   4
      Top             =   3240
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cAmarillo 
      Height          =   375
      Left            =   480
      TabIndex        =   5
      Top             =   3720
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cMorado 
      Height          =   375
      Left            =   1560
      TabIndex        =   6
      Top             =   3720
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cVerde 
      Height          =   375
      Left            =   2640
      TabIndex        =   7
      Top             =   3720
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cMarron 
      Height          =   375
      Left            =   3600
      TabIndex        =   8
      Top             =   3720
   ...
   Begin ClientGSZAO.uAOButton cAceptar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOCheckbox chkNegrita 
      Height          =   345
      Left            =   1080
      TabIndex        =   10
      Top             =   4320
   ...
   End
   Begin ClientGSZAO.uAOCheckbox chkCursiva 
      Height          =   345
      Left            =   3000
      TabIndex        =   12
      Top             =   4320
...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(pathGUI & "frmCambiaMotd.jpg")
