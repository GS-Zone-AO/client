...
Begin VB.Form frmTutorial 
   ...
   Begin ClientGSZAO.uAOCheckbox chkNoMostrar 
      Height          =   345
      Left            =   3120
      TabIndex        =   4
      Top             =   6960
   ...
   End
   Begin ClientGSZAO.uAOButton cAnterior 
      Height          =   495
      Left            =   480
      TabIndex        =   5
      Top             =   6840
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cSiguiente 
      Height          =   495
      Left            =   6600
      TabIndex        =   6
      Top             =   6840
...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(pathGUI & "frmTutorial.jpg")
...
On Error Resume Next
    ...
    TutorialPath = pathExtras & "Tutorial.dat"
