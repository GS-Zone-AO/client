...
Begin VB.Form frmParty 
   ...
   Begin ClientGSZAO.uAOButton cSalirParty 
      Height          =   375
      Left            =   360
      TabIndex        =   9
      Top             =   5400
   ...
   Begin ClientGSZAO.uAOButton cCerrar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cAgregar 
      Height          =   375
      Left            =   2040
      TabIndex        =   5
      Top             =   4800
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cLiderGrupo 
      Height          =   375
      Left            =   2880
      TabIndex        =   6
      Top             =   3480
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cExpulsar 
      Height          =   375
      Left            =   1320
      TabIndex        =   7
      Top             =   3480
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cDisolver 
      Height          =   375
      Left            =   360
      TabIndex        =   8
      Top             =   5400
...
Private Sub Form_Load()
    ...
    If EsPartyLeader Then
        Me.Picture = LoadPicture(pathGUI & "frmPartyLider.jpg")
        Me.Height = LEADER_FORM_HEIGHT
    Else
        Me.Picture = LoadPicture(pathGUI & "frmPartyMiembro.jpg")
