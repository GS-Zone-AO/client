...
Begin VB.Form frmGuildLeader 
   ...
   Begin ClientGSZAO.uAOButton cCerrar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cDetallesClan 
      Height          =   375
      Left            =   150
      TabIndex        =   8
      Top             =   2700
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cDetallesMiembro 
      Height          =   375
      Left            =   3030
      TabIndex        =   9
      Top             =   2700
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cDetallesSolicitud 
      Height          =   375
      Left            =   150
      TabIndex        =   10
      Top             =   6045
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cAbrirElecciones 
      Height          =   375
      Left            =   150
      TabIndex        =   11
      Top             =   6840
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cActualizar 
      Height          =   375
      Left            =   150
      TabIndex        =   12
      Top             =   4230
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cEditarCodex 
      Height          =   375
      Left            =   3030
      TabIndex        =   13
      Top             =   4680
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cEditarURL 
      Height          =   375
      Left            =   3030
      TabIndex        =   14
      Top             =   5130
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cPropuestasPaz 
      Height          =   495
      Left            =   3030
      TabIndex        =   15
      Top             =   5565
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cPropuestasAlianzas 
      Height          =   495
      Left            =   3030
      TabIndex        =   16
      Top             =   6120
