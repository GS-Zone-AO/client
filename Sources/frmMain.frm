...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fMenu 
      ...
      Visible         =   0   'False
      Width           =   1575
      Begin ClientGSZAO.uAOCheckbox chkMiniMap 
         Height          =   225
         Left            =   120
         TabIndex        =   46
         Top             =   120
      ...
      Begin ClientGSZAO.uAOButton cOpciones 
         ...
         EndProperty
      End
      Begin ClientGSZAO.uAOButton cMapa 
         Height          =   255
         Left            =   120
         TabIndex        =   40
         Top             =   1560
         ...
         EndProperty
      End
      Begin ClientGSZAO.uAOButton cGrupo 
         Height          =   255
         Left            =   120
         TabIndex        =   41
         Top             =   840
         ...
         EndProperty
      End
      Begin ClientGSZAO.uAOButton cEstadisticas 
         Height          =   255
         Left            =   120
         TabIndex        =   42
         Top             =   480
         ...
         EndProperty
      End
      Begin ClientGSZAO.uAOButton cClanes 
         Height          =   255
         Left            =   120
         TabIndex        =   43
         Top             =   1200
         ...
         EndProperty
      End
      Begin ClientGSZAO.uAOButton cNotas 
         Height          =   255
         Left            =   120
         TabIndex        =   44
         Top             =   2280
   ...
   Begin VB.PictureBox picInv 
      ...
      Width           =   2400
   End
   Begin ClientGSZAO.uAOAnimLongLabel lblOro 
      Height          =   255
      Left            =   10680
      TabIndex        =   36
      Top             =   6345
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOProgress cStatEnergia 
      Height          =   180
      Left            =   9840
      TabIndex        =   29
      Top             =   7515
   ...
   Begin ClientGSZAO.uAOButton cCerrar 
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cMinimizar 
      Height          =   255
      Left            =   11400
      TabIndex        =   4
      Top             =   0
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cAsignarSkills 
      Height          =   255
      Left            =   11040
      TabIndex        =   24
      Top             =   1605
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cInventario 
      Height          =   375
      Left            =   8985
      TabIndex        =   0
      Top             =   1965
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cHechizos 
      Height          =   375
      Left            =   10215
      TabIndex        =   1
      Top             =   1965
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOProgress cStatMana 
      Height          =   225
      Left            =   8760
      TabIndex        =   30
      Top             =   6720
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOProgress cStatVida 
      Height          =   225
      Left            =   8760
      TabIndex        =   32
      Top             =   7080
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOProgress cStatHambre 
      Height          =   180
      Left            =   9840
      TabIndex        =   33
      Top             =   7815
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOProgress cStatSed 
      Height          =   180
      Left            =   9840
      TabIndex        =   34
      Top             =   8130
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOProgress cStatExp 
      Height          =   225
      Left            =   9015
      TabIndex        =   35
      Top             =   1140
      ...
      EndProperty
   End
   Begin ClientGSZAO.uAOButton cMenu 
      Height          =   855
      Left            =   8760
      TabIndex        =   37
      Top             =   7440
...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(pathGUI & "frmMain.jpg")
            ...
            If Inventario.GrhIndex(Inventario.SelectedItem) > 0 Then
                ...
                If last_i > 0 And last_i <= MAX_INVENTORY_SLOTS Then
                    ...
                    If poss = 0 Then
                        ...
                        If Get_Image(pathGraphics, CStr(GrhData(Inventario.GrhIndex(Inventario.SelectedItem)).FileNum), data, True) Then
            ...
            If Spells.GrhIndex(Spells.SelectedItem) > 0 Then
                ...
                If last_i > 0 And last_i <= 30 Then
                    ...
                    If poss = 0 Then
                        ...
                        If Get_Image(pathGraphics, CStr(GrhData(Spells.GrhIndex(Spells.SelectedItem)).FileNum), data, True) Then
                            Set bmpData = ArrayToPicture(data(), 0, UBound(data) + 1) ' GSZAO
